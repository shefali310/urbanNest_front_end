  ...
  return (
    <div className="bg-gray-800 pb-16 pt-10">
      <div className="container mx-auto flex flex-col gap-8 items-center">
        <h1 className="text-6xl sm:text-4xl text-white font-bold mb-4">
          Welcome to Our Hotel booking site
        </h1>
        ...
        <div className="mt-8">
          <h2 className="text-4xl sm:text-2xl text-white font-bold mb-4 text-center">
            Our Commitment to Excellence
          </h2>
          <p className="text-lg text-white max-w-2xl text-center">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
            euismod, justo nec sagittis facilisis, augue ex faucibus leo, sit
            amet posuere tellus urna nec nisi.
          </p>
        </div>
      </div>
    </div>
