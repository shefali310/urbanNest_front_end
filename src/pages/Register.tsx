...
const Register = () => {
    ...
    return (
        <form className="flex flex-col gap-5" onSubmit={onSubmit}>
            ...
            <span className="text-sm">Already a member? <Link to="/sign-in" className="font-bold underline">Login</Link></span>
                <button type="submit" className="bg-green-600 text-white p-2 rounded font-bold">Create Account</button>
            </span>
        </form>
